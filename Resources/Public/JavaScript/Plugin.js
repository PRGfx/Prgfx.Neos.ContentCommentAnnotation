...
/***/ "./node_modules/react-dom-instance/react-dom-instance.js":
/*!***************************************************************!*\
  !*** ./node_modules/react-dom-instance/react-dom-instance.js ***!
  \***************************************************************/
/*! no static exports found */
...
var CommentStatus = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
    ...
    sidebarHidden: _neosUiReduxStore.selectors.UI.RightSideBar.isHidden
}), {
    toggleSidebar: _neosUiReduxStore.actions.UI.RightSideBar.toggle
}), _dec(_class = _dec2(_class = (_temp2 = _class2 = function (_PureComponent) {
    _inherits(CommentStatus, _PureComponent);
    ...
    function CommentStatus() {
        ...
        _classCallCheck(this, CommentStatus);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CommentStatus.__proto__ || Object.getPrototypeOf(CommentStatus)).call.apply(_ref, [this].concat(args))), _this), _this.handleShowComments = function () {
            var _this$props = _this.props,
                sidebarHidden = _this$props.sidebarHidden,
                toggleSidebar = _this$props.toggleSidebar;


            var focusTab = function focusTab() {
                return (0, _util.focusInspectorTab)(_this.getCommentsTab());
            };
        ...
        }, _this.getCommentsTab = function () {
            var _this$props2 = _this.props,
                node = _this$props2.node,
                nodeTypeRegistry = _this$props2.nodeTypeRegistry;
            ...
            var nodeType = nodeTypeRegistry.get(node.nodeType);
            if (!nodeType) {
                return null;
            }

            var inspectorConfig = (0, _plowJs.$get)(['properties', 'comments', 'ui', 'inspector'], nodeType);

            var _ref2 = inspectorConfig || {},
                editor = _ref2.editor,
                group = _ref2.group;
            ...
            var uiGroup = (0, _plowJs.$get)(['ui', 'inspector', 'groups', group], nodeType);
    ...
    _createClass(CommentStatus, [{
        ...
        value: function render() {
            ...
            var comments = JSON.parse(node.properties.comments || '[]');
            var commentCount = comments.filter(function (c) {
                return c.deleted !== true;
            }).length;

            var disabled = this.getCommentsTab() === null;
            ...
            return _react2.default.createElement(
                ...
                commentCount > 0 && _react2.default.createElement(
                    'span',
                    { className: _styles2.default.commentCount },
                    commentCount
                )
            );
        }
    ...
    nodeTypeRegistry: _propTypes2.default.object.isRequired,
    sidebarHidden: _propTypes2.default.bool,
    toggleSidebar: _propTypes2.default.function
}, _temp2)) || _class) || _class);
exports.default = CommentStatus;
...
var _CommentStatus = __webpack_require__(/*! ./CommentStatus */ "./src/CommentStatus.js");

var _CommentStatus2 = _interopRequireDefault(_CommentStatus);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Prgfx.Neos.ContentCommentAnnotation', {}, function (globalRegistry) {
    var guestFrameRegistry = globalRegistry.get('@neos-project/neos-ui-guest-frame');
    guestFrameRegistry.set('NodeToolbar/Buttons/ContentComments', _CommentStatus2.default);
});
...
module.exports = {"iconWrapper":"styles__iconWrapper___2oS38","commentCount":"styles__commentCount___2tPgp"};
...
exports.focusInspectorTab = undefined;

var _reactDomInstance = __webpack_require__(/*! react-dom-instance */ "./node_modules/react-dom-instance/react-dom-instance.js");
 ...
 */
var focusInspectorTab = exports.focusInspectorTab = function focusInspectorTab(id) {
    var inspectorNode = document.getElementById('neos-Inspector');
    if (!inspectorNode) {
    ...
    try {
        var tabsNode = inspectorNode.querySelector('[role=tablist]');
        if (!tabsNode) {
            console.warn('could not find tabs element');
            return;
        }

        var tabsInstance = (0, _reactDomInstance.findInstance)(tabsNode);
        ...
        // properties or views
        var children = tabsInstance.props.children;
        var tabIndex = children.findIndex(function (c) {
            return c.key === id;
        });
        if (tabIndex < 0) {
